...
type PostArgs struct {
	Text     string `json:"text" jsonschema:"the message body to send, as standard Markdown: bold, headings, links, lists, tables and fenced code are rendered by Slack. Text over 12000 characters is sent unrendered"`
...
type AskArgs struct {
	Question       string   `json:"question" jsonschema:"the question to ask, as standard Markdown, rendered the same way slack_post is"`
